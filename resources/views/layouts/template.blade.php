  ...
  <div class="wrapper">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle text-muted pr-0" href="#" id="navbarDropdownMenuLink" role="button"
            ...
            <span class="avatar avatar-sm mt-2">
              <strong class="pr-1 pt-1">{{ Auth::user()->name }}</strong>
              <img src="{{ asset('avatars/'.Auth::user()->avatar) }}" alt="..." class="avatar-img rounded-circle">
            </span>
          </a>
          
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
            <div class="dropdown-item"><a href="{{ route('umkm.profile')}}" class="dropdowh-item text-decoration-none" type="button">Profil</a></div>
    ...
    <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
      ...
      <nav class="vertnav navbar navbar-light">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          ...
          <li class="nav-item w-100">
            <a class="nav-link" href="{{ route('transaction.index') }}">
              ...
              <span class="ml-3 item-text">Data Penjualan</span>
            </a>
          </li>
          <li class="nav-item w-100">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          ...
          <li class="nav-item w-100">
            <a class="nav-link" href="{{ route('gallery.index') }}">
              ...
              <span class="ml-3 item-text">Galeri Produk</span>
            </a>
          </li>
          <li class="nav-item w-100">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          <li class="nav-item w-100">
            <a class="nav-link" href="/umkm/complaint">
              <i class="fe fe-alert-circle fe-16"></i>
              <span class="ml-3 item-text">Komplain</span>
            </a>
          </li>
        </ul>
        <!-- <ul class="navbar-nav flex-fill w-100 mb-2">
          ...
          <li class="nav-item w-100">
            <a class="nav-link" href="{{ route('kas.index') }}">
              ...
              <span class="ml-3 item-text">Alur Kas</span>
            </a>
          </li>
          <li class="nav-item w-100">
            <a class="nav-link" href="#">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          <p class="text-muted nav-heading mt-4 mb-1">
            <span>Sumber Daya Manusia (HR)</span>
          </p>
          <li class="nav-item w-100">
            <a class="nav-link" href="#">
              <i class="fe fe-circle"></i>
              <span class="ml-3 item-text">Daftar Karyawan</span>
            </a>
          </li>
          <li class="nav-item w-100">
            <a class="nav-link" href="#">
        ...
        <ul class="navbar-nav flex-fill w-100 mb-2">
          ...
          <li class="nav-item w-100">
            <a class="nav-link" href="#">
              <i class="fe fe-circle"></i>
              <span class="ml-3 item-text">Menu Lainnya</span>
            </a>
          </li>
          <li class="nav-item w-100">
            <a class="nav-link" href="#">
