...
<div class="row justify-content-center">
    <div class="col-12">
        <!-- <div class="row align-items-center mb-2">
            <div class="col">
                <h2 class="h5 page-title">Komplain UMKM</h2>
                <p></p>
            </div>
        </div> -->
            ...
            <div class="col-md-12 col-lg-12">
                <div class="card shadow">
                    <div class="card-header">
                        ...
                        <a class="btn btn-sm btn-outline-primary float-right" href="/admin/complaint-done">Komplain teratasi<span class="fe fe-chevron-right fe-16 ml-2"></span></a>
                    </div>
                    <div class="card-body my-n2">
                        <table class="table table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                @forelse($complaints_handled as $complaint)
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route('admin.complaint_handled', ['id' => $complaint->complaint_id])}}" class="btn btn-sm btn-primary">Tangani</a></td>
                                    <!-- <td>
                                        <div class="dropdown">
                                            <button class="btn btn-sm dropdown-toggle more-vertical" type="button" id="dr1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <span class="text-muted sr-only">Action</span>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dr1">
                                                <a class="dropdown-item" href="#">Rincian</a>
